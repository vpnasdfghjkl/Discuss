...
col_dict_daylight_robot = {
    ...
    # "purple": {"hsv_l": np.array([100, 75, 63]), "hsv_h": np.array([155, 223, 179])},
...
col_dict_daylight_shelf_1 = {
    ...
    #M at 01101224 by HX because column 2 problem "pink": {"hsv_l": np.array([130, 90, 74]), "hsv_h": np.array([180, 140, 255])},
    "pink": {"hsv_l": np.array([156, 90, 84]), "hsv_h": np.array([180, 214, 255])},
...
col_dict_daylight_shelf_23 = {
    ...
    "pink": {"hsv_l": np.array([160, 71, 74]), "hsv_h": np.array([180, 145, 255])},
    # "green": {"hsv_l": np.array([40, 60, 50]), "hsv_h": np.array([77, 204, 255])},
    "green": {"hsv_l": np.array([33, 40, 0]), "hsv_h": np.array([72, 125, 255])},
    # "purple": {"hsv_l": np.array([100, 75, 63]), "hsv_h": np.array([155, 223, 179])},
...
col_dict_night_robot = {
    ...
    "green": {"hsv_l": np.array([30, 65, 50]), "hsv_h": np.array([44, 150, 200])},
    "purple": {"hsv_l": np.array([116, 79, 0]), "hsv_h": np.array([153, 255, 255])},
...
col_dict_night_shelf_1 = {
    ...
    "purple": {"hsv_l": np.array([116,50, 0]), "hsv_h": np.array([153, 255, 255])},
