...
col_dict_daylight_robot = {
    ...
    "col_dict_daylight_robotgreen": {"hsv_l": np.array([30, 50, 70]), "hsv_h": np.array([55, 220, 220])}, #g12
    "col_dict_daylight_robotcyan": {"hsv_l": np.array([80,40,70]), "hsv_h": np.array([116,255,255])},
    "col_dict_daylight_robotblue": {"hsv_l": np.array([96,80,20]), "hsv_h": np.array([125,255,230])},
...
col_dict_daylight_shelf_1 = {
    ...
    "col_dict_daylight_shelf_1yellow": {"hsv_l": np.array([20, 69, 44]), "hsv_h": np.array([28, 200, 255])},
    "col_dict_daylight_shelf_1green": {"hsv_l": np.array([30, 40, 60]), "hsv_h": np.array([57, 255, 255])},
    "col_dict_daylight_shelf_1cyan": {"hsv_l": np.array([80,50,40]), "hsv_h": np.array([116,255,255])},
    "col_dict_daylight_shelf_1blue": {"hsv_l": np.array([96,60,50]), "hsv_h": np.array([125,255,230])},
...
col_dict_daylight_shelf_23 = {
    ...
    "col_dict_daylight_shelf_23yellow": {"hsv_l": np.array([20, 75, 31]), "hsv_h": np.array([28, 200, 255])},
    "col_dict_daylight_shelf_23green": {"hsv_l": np.array([30, 50, 30]), "hsv_h": np.array([50, 255, 255])},
    "col_dict_daylight_shelf_23cyan": {"hsv_l": np.array([80,30,30]), "hsv_h": np.array([116,255,255])},
    "col_dict_daylight_shelf_23blue": {"hsv_l": np.array([96,60,20]), "hsv_h": np.array([125,255,230])},
...
col_dict_night_robot = {
    ...
    "col_dict_night_robotgreen": {"hsv_l": np.array([30, 65, 50]), "hsv_h": np.array([55, 200, 200])},
...
col_dict_night_shelf_1 = {
    ...
    "col_dict_night_shelf_1yellow": {"hsv_l": np.array([20, 69, 44]), "hsv_h": np.array([28, 200, 255])},
...
col_dict_night_shelf_23 = {
    ...
    "col_dict_night_shelf_23yellow": {"hsv_l": np.array([20, 75, 31]), "hsv_h": np.array([28, 200, 255])},
    "col_dict_night_shelf_23green": {"hsv_l": np.array([33, 40, 0]), "hsv_h": np.array([72, 200, 255])},
