...
# import Arm1_server 
from Arm1_server import update_image_cb_to_none
#===============================================================MODIFY
'''����ɫʶ��:
        ...
        if found_color is not None:  
            ...
            if res :
                ...
                if robot_service :
                    ...
                    run_done = True
                    # print("to_center->wait for updating run_done")
                    # time.sleep(0.5)
                    #print('ok')
                else:
                    exit(0)
        ...
        if found_color is not None:  
            ...
            if res:
                ...
                #print(res)
                    if res:
                        run_done = True
                        # print("totate->wait for updating run_done")
                        # time.sleep(0.5)
                    else:
