...
col_dict_daylight_robot = {
    ...
    "col_dict_daylight_robotpink": {"hsv_l": np.array([159, 71, 124]), "hsv_h": np.array([180, 145, 200])}, ###wangwei 12.20
    # "yellow": {"hsv_l": np.array([13, 82, 223]), "hsv_h": np.array([35, 255, 255])},
    "col_dict_daylight_robotgreen": {"hsv_l": np.array([30, 65, 100]), "hsv_h": np.array([44, 150, 200])},
...
col_dict_daylight_shelf_1 = {
    ...
    #M at 01101224 by HX because column 2 problem 
    #"pink": {"hsv_l": np.array([130, 90, 74]), "hsv_h": np.array([180, 140, 255])},
    "col_dict_daylight_shelf_1pink": {"hsv_l": np.array([156, 90, 84]), "hsv_h": np.array([180, 214, 255])},
    #M at 01111023 by HX because column 5 light on green cube influenced by 1st move_to_center 
    #"green": {"hsv_l": np.array([40, 30, 65]), "hsv_h": np.array([77, 255, 255])},
    "col_dict_daylight_shelf_1green": {"hsv_l": np.array([22, 50, 24]), "hsv_h": np.array([57, 255, 228])},
    "col_dict_daylight_shelf_1purple": {"hsv_l": np.array([116,50, 0]), "hsv_h": np.array([153, 255, 255])},
}
col_dict_daylight_shelf_23 = {
    # "blue": {"hsv_l": np.array([99,80,115]), "hsv_h": np.array([115,222,209])},
    "col_dict_daylight_shelf_23pink": {"hsv_l": np.array([160, 71, 74]), "hsv_h": np.array([180, 145, 255])},
    # "green": {"hsv_l": np.array([40, 60, 50]), "hsv_h": np.array([77, 204, 255])},
    "col_dict_daylight_shelf_23green": {"hsv_l": np.array([33, 40, 0]), "hsv_h": np.array([72, 125, 255])},
...
col_dict_night_robot = {
    ...
    "col_dict_night_robotpink": {"hsv_l": np.array([159, 64, 124]), "hsv_h": np.array([180, 145, 200])},
    "col_dict_night_robotgreen": {"hsv_l": np.array([30, 65, 50]), "hsv_h": np.array([44, 150, 200])},
...
col_dict_night_shelf_1 = {
    ...
    "col_dict_night_shelf_1pink": {"hsv_l": np.array([159, 64, 124]), "hsv_h": np.array([180, 150, 230])},
    "col_dict_night_shelf_1green": {"hsv_l": np.array([30, 50, 100]), "hsv_h": np.array([60, 150, 230])},
...
col_dict_night_shelf_23 = {
    ...
    "col_dict_night_shelf_23pink": {"hsv_l": np.array([160, 64, 124]), "hsv_h": np.array([180, 145, 200])},
    "col_dict_night_shelf_23green": {"hsv_l": np.array([33, 40, 0]), "hsv_h": np.array([72, 125, 255])},
